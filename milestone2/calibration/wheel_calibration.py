...
def calibrateWheelRadius():
    ...
    wheel_velocities_range = [20, 20, 20, 20, 20]
    delta_times = []
    ...
    for wheel_vel in wheel_velocities_range:
        ...
        while True:
            ...
            ppi.set_velocity([1, 0], tick=[18.4,wheel_vel], time=delta_time)
...
def calibrateBaseline(scale):
    ...
    ##########################################
    #wheel_velocities_range = range(10, 25, 5)  # or use np.linspace
    wheel_velocities_range = [10, 10, 10, 10, 10]
    delta_times = []
    ...
    for wheel_vel in wheel_velocities_range:
        ...
        while True:
            ...
            ppi.set_velocity([0, 1], tick=[wheel_vel, wheel_vel], time = delta_time)
