...
class Robot:
    ...
    def derivative_drive(self, drive_meas):
        ...
        # Compute DFx using lin_vel, ang_vel, dt, and th
        # Formulas found in drive() function line 16
        # Or just do differentiation to x y position based on practical 2
        if ang_vel == 0:
    ...
    def covariance_drive(self, drive_meas):
        ...
        # Compute Jac2 using lin_vel, ang_vel, dt, th, and th2
        # Derivative of formulas for x,y in practical 2 function and theta in case where angular velocity != 0
        if ang_vel == 0:
