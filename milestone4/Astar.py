...
def main():
    ...
    fruits_list, fruits_true_pos, gt_aruco = read_true_map("M4_true_map.txt")
    ...
    for marker in range(0,len(gt_aruco)):
        ox.append(gt_aruco[marker][0])
        oy.append(gt_aruco[marker][1])

    for fruits in range(0,len(fruits_true_pos_seq)):
        ox.append(fruits_true_pos_seq[fruits][0]+0.121)
        oy.append(fruits_true_pos_seq[fruits][1]+0.121)

    if show_animation:  # pragma: no cover
        for marker in range(0,len(gt_aruco)):
            plt.plot(gt_aruco[marker][0],gt_aruco[marker][1], ".k")
        for i in range(0,len(fruits_list)):
            plt.plot(fruits_true_pos_seq[i][0], fruits_true_pos_seq[i][1], "or")
